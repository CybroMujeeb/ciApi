...
//$this->response('1');
        ...
        if ($this->config->item('rest_enable_keys') && empty($this->rest->key) === FALSE)
        {
            ...
            $level = isset($this->methods[$controller_method]['level']) ? $this->methods[$controller_method]['level'] : 2;
            ...
            if($this->rest->level > 1){

                $this->rest->db
                ->where(config_item('rest_key_column'), $this->rest->key)
                ->delete(config_item('rest_keys_table'));

            }
            
            //$this->response($authorized);
        }
    ...
    public function delete($key = NULL, $xss_clean = NULL)
    {
        ...
        //print_r($this->_delete_args); return;
