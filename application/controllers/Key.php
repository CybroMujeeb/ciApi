...
class Key extends REST_Controller {
    ...
    public function index_put()
    {
        ...
        // Insert the new key
        if ($this->_insert_key($key, ['level' => $level, 'ignore_limits' => $ignore_limits, 'ip_addresses' => $this->_getRealIpAddr()]))
        {
            $this->response([
                'status' => TRUE,
                'key' => $key
    ...
    {
        $key = $this->delete(config_item('rest_key_name'));
    ...
    public function regenerate_post()
    {
        ...
        // Insert the new key
        if ($this->_insert_key($new_key, ['level' => $key_details->level, 'ignore_limits' => $key_details->ignore_limits, 'ip_addresses' => $this->_getRealIpAddr()]))
        {
            // Suspend old key
